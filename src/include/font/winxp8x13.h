#ifndef __FONT_WINXP8X13_H
#define __FONT_WINXP8X13_H

#define VGAFONT_USED 1

/* taken from windows xp source code :) */
static uint8_t fontdata_winxp[] = {
...
static const struct console_font font_winxp8x13 = {
  .width        = 8,
  .height       = 13,
  .char_count   = 256,
  .data         = fontdata_winxp
