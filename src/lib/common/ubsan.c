...
extern "C"
{
    ...
    {
        debug("tinyubsan: %s at file %s, line %d, column %d\n", message, loc.file, loc.line, loc.column);
    }
    ...
    void __ubsan_handle_function_type_mismatch(struct tu_type_function_mismatch_data * data, uintptr_t _unused_ ptr) {
